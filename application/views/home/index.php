                                                            ...
                                                            <li class="task-list-item done <?=($isLast ? 'last-item' : '')?>">
                                                                ...
                                                                <div class="task-content">
                                                                    <h4 class="uppercase bold">
                                                                        <a href="<?=base_url().'home/courseDetail/'.$branch['branchId']?>" target="_blank"><?=$branch['branchNameTH']?></a>
                                                                        <!--<span onClick="onBranchClick('<?=$branch['branchId']?>')" style="cursor: pointer;"><?=$branch['branchNameTH']?></span>-->
                                                                    </h4>
                                                                    <a href="<?=base_url().'home/courseDetail/'.$branch['branchId']?>" target="_blank"><font style="font-size: 0.75em;">รายละเอียดสาขา</font></a>
                                                                </div>
                                                            </li>
                                                            <?php } ?>
                                                        </ul>
